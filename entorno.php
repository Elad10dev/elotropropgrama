    ...
    <div class="row" id='maincontainer' style="display:none;">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link <?php echo ($_SESSION['activelogo'] === '' ? 'active' : '');  ?>" id="Regional-tab" data-bs-toggle="tab" data-bs-target="#Regional" type="button" role="tab" aria-controls="home" aria-selected="true"><i class="fa fa-cogs"></i> <?php echo lang('Regional'); ?></button>
            </li>
            <li class="nav-item " role="presentation">
                <button class="nav-link <?php echo ($_SESSION['activelogo'] !== '' ? 'active' : '');  ?>" id="Logotipo-tab" data-bs-toggle="tab" data-bs-target="#Logotipo" type="button" role="tab" aria-controls="profile" aria-selected="false"><i class="fa fa-image"></i> <?php echo lang('Logotipo'); ?></button>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="SMTP-tab" data-bs-toggle="tab" data-bs-target="#SMTP" type="button" role="tab" aria-controls="contact" aria-selected="false"><i class="fa fa-file-code-o"></i> <?php echo lang('SMTP'); ?></button>
            </li>
        </ul>
        <div class="tab-content p-0" id="myTabContent">
            <div class="tab-pane fade  <?php echo ($_SESSION['activelogo'] === '' ? 'show active' : '');  ?>" id="Regional" role="tabpanel">
                <div class="card">
                    ...
                    <div class="card-body p-1">
                        ...
                        <div class="row">
                            ...
                            <div class="row" <?php echo ($printcaja == 0 ? "style='display:none'" : ""); ?>>
                                <div class="col-12">
            ...
            <div class="tab-pane fade <?php echo ($_SESSION['activelogo'] !== '' ? 'show active' : '');
                                        $_SESSION['activelogo'] = ''; ?>" id="Logotipo" role="tabpanel" aria-labelledby="profile-tab">
                <div class="card">
                    <div class="card-header">
            ...
            <div class="tab-pane fade" id="SMTP" role="tabpanel">
                <div class="card">
                    <div class="card-header">
                        <h5 class="modal-title"><i class="fa fa-file-code-o"></i> <?php echo lang('SMTP'); ?></h5>
                    </div>
                    <div class="card-body p-1">
                        <div class="row">
                            <div class="col-12 col-lg-6 my-1">
