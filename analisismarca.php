...
<head>
    ...
    <title><?php echo lang("Análisis de Marca"); ?></title>
...
<body>
    ...
    <button class='ocultoimpresion ' onclick='document.getElementById(`formexcel`).submit()'><img src='/img/excel.png' width='28' height='28'><br><?php echo lang("Marcas"); ?><br></button>
    <div class="pagina" style="font-size: 12px;">
        <div class="sup">
            ...
            <div style="float:left; width: 53%;">
                <div class="TituloEmpresa" style="float: center; text-align: center;"><?php echo lang("Análisis de Marcas"); ?></div>
                <div class="Subtituloempresa" style="float: center; text-align: center; font-weight: 600; font-size: 12px;"><?php echo lang("Orden por"); ?>:<?php echo $_POST["OrdenA22"]; ?> <?php if ($_POST["DesdeAX2z"] == true) {
                                                                                                                                                                                                    echo lang("Desde la marca") . ":" . $_POST["DesdeAX22z"];
                                                                                                                                                                                                } ?> <?php if ($_POST["HastaAX2z"] == true) {
                                                                                                                                                                                                            echo lang("hasta la marca") . ": " . $_POST["HastaAX22z"];
                                                                                                                                                                                                        } ?></div>
                <div class="Subtituloempresa" style="float: center; text-align: center; font-weight: 600; font-size: 12px;"><?php if ($_POST["BeneficiarioAX2z"] == true or $_POST["AlmacenAX2z"] == true) {
                                                                                                                                echo lang("Con") . ":";
                                                                                                                            } else {
                                                                                                                                echo "--------------------";
                                                                                                                            } ?><?php if ($_POST["BeneficiarioAX2z"] == true) {
                                                                                                                                    echo lang("Beneficiario") . ": " . $_POST["BeneficiarioAX22z"];
                                                                                                                                } ?> <?php if ($_POST["AlmacenAX2z"] == true) {
                                                                                                                                            echo "  " . lang("Almacen") . ":" . $_POST["AlmacenAX22z"];
                                                                                                                                        } ?> </div>
                <div class="Subtituloempresa" style="float: center; text-align: center; font-weight: 600; font-size: 12px;"><?php echo lang("Fecha") . ":" . $_POST["FECHAX2z"];
                                                                                                                            " " . lang("hasta") . "  " . $_POST["FECHAX22z"]; ?></div>
            </div>
            <div style="float:left; width: 23%;">
...
*/
            ...
            if (trim($_POST["OrdenA22"]) == "Ventas") {
                $Orden = "order by Monto desc";
            }
            if (trim($_POST["OrdenA22"]) == "Cantidad") {
                $Orden = "order by Cantidad desc";
            }
            if (trim($_POST["OrdenA22"]) == "Utilidad") {
                $Orden = "order by util desc";
            }


            // if ($_POST["DesdeAX2z"] == true and $_POST["HastaAX2z"] == true) {
            //     $beetween = "and h.idmarca  between '" . $_POST["DesdeAX2z"] . "' and '" . $_POST["HastaAX2z"] . "' ";
            // }
            // if ($_POST["DesdeAX"] == true and $_POST["HastaAX"] == false) {
            //     $beetween = "and h.idmarca between '" . $_POST["DesdeAX2z"] . "' and '" . $_POST["DesdeAX2z"] . "' ";
            // }
            // if ($_POST["DesdeAX"] == false and $_POST["HastaAX"] == true) {
            //     $beetween = "and h.idmarca between '" . $_POST["HastaAX2z"] . "' and '" . $_POST["HastaAX2z"] . "' ";
            // }
            if (!empty($_POST["mIdMarca"])) {
                $beetween = " and h.idmarca in ('" . implode("','", $_POST["mIdMarca"]) . "') ";
            }
            $limit = " limit " . $_POST["cant223"];
            $fechaA = $_POST["FECHAX2z"];
            ...
            ?>
                    <div style="text-align: left; float:left; width: 100%;">
                        <div style="text-align: left; float:left; width: 100%;">
                            ...
                            <div class="campo" style=" text-align: left; width: 30%; "><?php if ($row['Marca'] == "") {
                                                                                            echo "-";
                                                                                        } else {
                                                                                            echo $row['Marca'];
                                                                                        } ?></div>
                        ...
                        ?>
                            ...
                            <div class="campo" style="visibility:hidden;  text-align: left; width: 30%; background-color: white;">Total Productos</div>
                            ...
                            <div class="campo" style=" text-align: left; width: 30%; background-color: white;"><?php echo lang("Total Productos"); ?></div>
                            <!--   ordenado      <div class="campo" style="  text-align: right; width:  4%; background-color: white;"></div>-->
                            <!--   Totales   -->
