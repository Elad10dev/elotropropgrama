...
<head>
    ...
    <title id="Titulodelapagina">BlackbuckPOS</title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="icon" href="img/AZUL.png" sizes="32x32" type="image/png">
    <link rel="icon" href="img/AZUL.png" sizes="16x16" type="image/png">
...
<body id="body-main" style="background-color:#FFFFF7; height: 100% !important;">
    ...
    <span class='d-print-none '>
        ...
        <div id='header-menu' class=" d-print-none">
            <nav class="navbar navbar-expand-lg d-flex justify-content-between">
                <div class="container-fluid">
                    ...
                    <div>
                        <div><i><img src="/img/BLANCO.png" width="100px" /></i></div>
                    </div>
                    <!--</a>-->
        ...
        <span class="d-none" id="FactorDolarZelle" name="FactorDolarZelle"><?php echo $_SESSION["FactorDolarZelle"] ?? ''; ?></span>
    ...
    <div class="modal" id="Modal-DeCargandoProcess" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div id="modalStockMinimo" class="modal fade" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div id="modal-vencemiento2" class="modal fade" data-bs-keyboard="false" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div id="apps-soporte" class="modal fade" data-bs-keyboard="false" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-primary text-light">
                    <h5 class="modal-title"> <img src="/img/BLANCO.png" style='max-width:100px;' /> <?php echo lang('Soporte Tecnico'); ?></h5>
                    <button data-bs-dismiss="modal" class="btn-close" type="button"></button>
                </div>
                <div class="modal-body">
                    <form action="generarTicket.php" id='formticket' method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <input type="hidden" name="sitioticket" id="sitioticket" value="blackbuckpos.com" />
    ...
    <div id="modal-numticket" class="modal fade" data-bs-keyboard="false" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal" id="modal-BadEnding" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal" id="modal-offline" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <img src="/img/procesando.gif" width="128" height="128" />
    ...
    <div id="modalPrint" class="modal fade" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div id="modalPrintCodBarra" class="modal fade" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo lang("Seleccionar Formato"); ?></h5>
...
<script>
    ...
    function cicloFavoritos() {
        ...
        const toggle = favoritos.filter(c => c.url == opcionApp);

        if (toggle.length > 0) {
            $("#toggleStarButton").addClass("active");
            document.getElementById("toggleStarButton").innerHTML = `<img src="/img/favoritos-enabled.png" width="24" />`;
        } else {
            $("#toggleStarButton").removeClass("active");
            document.getElementById("toggleStarButton").innerHTML = `<img src="/img/favoritos-disabled.png" width="24" />`;
        }
        let html = "";

        favoritos.forEach(e => {
            html += `
				<li class="dropdown-item ${e.url == opcionApp ? 'active' : ''}">
					<a class="nav-link text-light" aria-current="page" href="app.php?opcion=${e.url}&m=${e.IdModulo}">
						<i><img src="/img/${e.img}" width="18" height="18"></i> ${e.desc}
					</a>
				</li>
			`;
        });
    	...
    	$("#StockMinimotable").DataTable({
    		...
    		ajax: {
    			...
    			data: {
    				...
    				MonedaP: document.getElementById("MonedaP").innerHTM,
    				implode: JSON.stringify(CodIdBasicoGroup),
    			},
    		},
    		destroy: true,
    	});
    ...
    function alertForMin() {
    	const button = `<button type="button" class="btn btn-dark px-1" onclick="VerStockMinimo();"> <i class="fa fa-search"></i> Ver Detalle </button>`;
    	alertBootstrap(
    		`Existencia Baja ${button}`,
    		`Hay varios productos que contienen una existencia por debajo del minimo`,
    		"warning",
    		"NotificacionesPa",
    		true,
    		0,
    	...
    	alertGo.forEach(alert => {
    		alertBootstraƒp(
    			`Existencia Baja ${alert.Descripcion}`,
    			`El Producto ${alert.Descripcion} tiene existencia por debajo del minimo`,
    			"warning",
    			"NotificacionesPa",
    			true,
    			0,
    ...
    function setcolorbg() {
        var rgb = $('#bgmenu').css('backgroundColor');
