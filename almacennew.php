...
$sqlcompany = "SELECT cantAlmacen FROM PosUpCompany where Id='" . $_SESSION['CompanyActual'] . "'";
	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			<div class="modal-header">
				<h5 id="titlemodal" class="modal-title"><?php echo lang('Editar Almacén'); ?></h4>
...
<div id="apps-copiar" class="modal fade" tabindex="-1" role="dialog" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
		<div class="modal-content">
