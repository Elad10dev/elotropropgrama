        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-1">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-2 mb-1"><hr class="m-0"></div>
                    ...
                    <div class="col-12 col-lg-6 my-1">
                        <div class="form-floating">
                            ...
                            <label><i class="fa fa-print"></i>&nbsp;<?php echo lang('Impresión Mov. Inventario') ?></label>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6 my-1">
                        <div class="form-floating">
                            ...
                            <label><i class="fa fa-print"></i>&nbsp;<?php echo lang('Impresión Mov. Inventario Personalizada') ?></label>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6 my-1">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="FormaISLR" name="FormaISLR" />
                            <label><i class="fa fa-file-text-o"></i>&nbsp;<?php echo lang('Formato ISLR Personalizado') ?></label>
                        </div>
                    </div>
                    
                    <div class="col-12 col-lg-6 my-1">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="FormaRETIVA" name="FormaRETIVA" />
                            <label><i class="fa fa-file-text-o"></i>&nbsp;<?php echo lang('Formato RETIVA Personalizado') ?></label>
                        </div>
                    </div>
                    <div class="col-12 mt-2 mb-1"><hr class="m-0"></div>
                    ...
                    <div class="col-12 col-lg-3 my-1">
                        ...
                        <div class="form-floating">
                            <select class="form-select" id="ModalAtencion" name="ModalAtencion">
                                ...
                                <?php echo $ModalDeposito22; ?>
                            </select>
                            <label><i class="fa fa-archive"></i> <?php echo lang('Zona de Atención'); ?></label>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-3 my-1">
                        <div class="form-floating">
                            ...
                            <label><i class="fa fa-credit-card"></i>&nbsp;<?php echo lang('Cashea Aliado') ?></label>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-3 my-1">
                        <div class="form-floating">
                            ...
                            <label><i class="fa fa-key"></i>&nbsp;<?php echo lang('Cashea Api-key') ?></label>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-3 my-1">
                        <div class="form-floating">
                            <select name="CasheaPrecio" id="CasheaPrecio" class="form-select">
                                <?php
                                $sql = "SELECT LitP01,LitP02,LitP03,LitP04,LitP05,LitP06,LitP07,LitP08,LitP09,LitP10 FROM PosUpCompany where Id=" . $_SESSION["CompanyActual"];
                                if ($result = mysqli_query($conn, $sql)) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        $LitP01 = $row["LitP01"]; $LitP02 = $row["LitP02"]; $LitP03 = $row["LitP03"];
                                        $LitP04 = $row["LitP04"]; $LitP05 = $row["LitP05"]; $LitP06 = $row["LitP06"];
                                        $LitP07 = $row["LitP07"]; $LitP08 = $row["LitP08"]; $LitP09 = $row["LitP09"];
                                        $LitP10 = $row["LitP10"];
                                    }
                                }
                                ?>
                            ...
                            <label><i class="fa fa-dollar"></i>&nbsp;<?php echo lang('Cashea Precio') ?></label>
                        </div>
                    </div>
...
<script>
    ...
    const Num001 = { title: "<?php echo lang('Falta Información'); ?>", desc: '<?php echo lang("El Campo Nombre no puede estar vacío."); ?>', };
    const Num002 = { title: "<?php echo lang('Falta Información'); ?>", desc: '<?php echo lang("El Campo Tipo no puede estar vacío."); ?>', };
    const Num003 = { title: "<?php echo lang('Falta Información'); ?>", desc: '<?php echo lang("Cree o elija una ubicación valida."); ?>', };
    const Num004 = { title: "<?php echo lang('Editar Almacén'); ?>", desc: '<?php echo lang("Editar Almacén"); ?>', };
    const Num005 = { title: "<?php echo lang('Guardar Almacén'); ?>", desc: '<?php echo lang("Guardar Almacén"); ?>', };
    const Num006 = { title: "<?php echo lang('Registro Asociado'); ?>", desc: '<?php echo lang("Este registro esta asociado, solo se puede inactivar."); ?>', };
    const Num007 = { title: "<?php echo lang('Limite de almacenes alcanzado'); ?>", desc: '<?php echo lang("Ha alcanzado el limite de almacenes que permite su plan."); ?>', };
</script>

<script src="jsdev/almacennew.js?v=<?php echo random_int(1, 9999999); ?>"></script>

<script>
// =========================================================================
// OVERRIDE FUNCIONES JS (Para asegurar lectura/escritura de los nuevos campos)
// =========================================================================
function guardar() {
    ...
    if (validaForm()) {
        ...
        // CHIVATO OPCIONAL (Descoméntalo si quieres ver la alerta antes de guardar)
        // alert("Atención: El sistema va a guardar en FormaISLR el texto: [" + valISLR + "]");
