...
function barraCod(cod) {
  ...
  if (document.getElementById("CompanyActual").innerHTML === "1140") {
    ImprimirCodBarra(cod, des);
    return;
  }
...
function html(numero) {
  ...
  editor.setData(document.getElementById("larga" + numero).value);
  editor2.setData(document.getElementById("corta" + numero).value);
}
